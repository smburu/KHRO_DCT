    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_period', models.IntegerField(default=2019, help_text='This Year marks the end of reporting. The value must be current year or greater than the start year', verbose_name='Ending Year')),
                ...
                ('string_value', models.CharField(blank=True, max_length=500, null=True, verbose_name='Comments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('afrocode', models.CharField(blank=True, max_length=10, verbose_name='AFRO Code')),
                ...
                ('periodicity', models.CharField(blank=True, max_length=200, null=True, verbose_name='Measurement Frequency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=500, verbose_name='Narrative Type Name')),
                ('shortname', models.CharField(max_length=120, null=True, unique=True, verbose_name='Short Name')),
                ('code', models.CharField(blank=True, max_length=50, unique=True, verbose_name='Narrative Code')),
