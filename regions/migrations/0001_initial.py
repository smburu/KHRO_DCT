    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_system', models.CharField(blank=True, max_length=100, unique=True, verbose_name='Source Name')),
                ('public_access', models.CharField(default='false', max_length=6, verbose_name='Location Code')),
            ],
            options={
