...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='stglocation',
            name='parent',
            field=models.ForeignKey(blank=True, help_text='You are not allowed to edit this field', null=True, on_delete=django.db.models.deletion.PROTECT, to='regions.StgLocation', verbose_name='Parent Location'),
        ),
        migrations.AddField(
            model_name='stglocation',
            name='zone',
